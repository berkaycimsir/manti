...
export function KanbanBoard({
	...
	const { sortBy, sortAsc, toggleSort } = useQueryViewStore();
...
function Column({
	...
	// For columns, we don't need useSortable since the SortableColumn wrapper handles it
	// This component just serves as the drop zone and content container

	return (
		<div className="flex h-full min-w-[320px] max-w-[320px] flex-col rounded-lg border border-border bg-muted/20">
