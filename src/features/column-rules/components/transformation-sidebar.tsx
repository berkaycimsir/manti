...
import { formatOptions } from "../utils/merge-rules";
import { LucideIcon } from "./shared/lucide-icon";
import { ToggleSwitch } from "./shared/toggle-switch";
import { TransformationOptionsEditor } from "./shared/transformation-options-editor";
...
export function TransformationSidebar({
	...
	const {
		...
		tableTransformations: transformations,
		hasTransformationOverride: getGlobalOverrideStatus,
		transformationMutations,
		isLoadingTransformations: isLoading,
		isLoadingGlobalTransformations: loadingGlobal,
	} = useColumnConfig({
		connectionId,
		tableName,
		enabled: isOpen,
	...
	// Mutations
	const createMutation = transformationMutations.create;
	const updateMutation = transformationMutations.update;
	const deleteMutation = transformationMutations.delete;
	...
	const handleAddTransformation = (
		...
		createMutation.mutate(
			...
			{
				onSuccess: () => setSelectedColumn(null),
			}
		);
	};
	...
	const handleUpdateOptions = (
		...
		updateMutation.mutate(
			...
			{
				onSuccess: () => setEditingTransformation(null),
			}
		);
	};
