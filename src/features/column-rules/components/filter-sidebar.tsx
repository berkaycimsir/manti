...
export function FilterSidebar({
	...
	const {
		...
		hasFilterOverride: getGlobalOverrideStatus,
		filterMutations,
		isLoadingFilters: isLoading,
		isLoadingGlobalFilters: loadingGlobal,
	} = useColumnConfig({
		connectionId,
		tableName,
		enabled: isOpen,
	...
	// Mutations
	const createFilter = filterMutations.create;
	const updateFilter = filterMutations.update;
	const deleteFilter = filterMutations.delete;
